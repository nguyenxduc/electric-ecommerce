...
const Collection = () => {
  ...
  const handleToggleCompare = (product: Product) => {
    setCompareProducts(prev => {
      ...
      if (prev.length > 0 && prev[0].category_id !== product.category_id) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 flex gap-8">
        ...
        >
          <div className="flex justify-between flex-col gap-3 mb-6 lg:flex-row lg:items-center">
            <SortDropdown
              options={sortOptions}
              selected={sortBy}
              onSelect={setSortBy}
              ...
              {products.products.length === 0 ? (
                ...
                <>
                  ...
                  <ProductGrid
                    ...
                    selectedCompareProducts={compareProducts}
